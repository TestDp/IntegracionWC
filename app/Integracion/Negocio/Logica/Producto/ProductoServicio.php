...
class ProductoServicio
{
 ...
 /* public function __construct(ServiceClientSag $clienteServicioSag){
    ...
    public function ConsultarProductosSAG( $fecha ){
        ...
        GetConsultaSagJson("SELECT concat(a.ss_detalle_artic2,' ',sc_referencia) as sc_detalle_articulo, a.k_sc_codigo_articulo, a.nd_valor_venta4 as precioDistribuidor,n_valor_venta_especial as precioMayorista,
